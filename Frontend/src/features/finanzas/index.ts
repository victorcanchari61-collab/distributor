...
export { PrestamosRecibidosPage } from './PrestamosRecibidosPage'
export { financiamientoApi } from './financiamientoApi'
export type { FinanciamientoResponse, PagoFinanciamientoResponse } from './financiamientoApi'
