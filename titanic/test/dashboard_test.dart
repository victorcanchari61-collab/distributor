...
void main() {
  ...
  group('con datos', () {
    ...
    testWidgets('ventas: sus gráficos y sus conclusiones', (tester) async {
      ...
      expect(find.text('S/ 48,250'), findsOneWidget);
    ...
    testWidgets('inventario: sin selector de período', (tester) async {
      ...
      expect(find.byType(GraficoDona), findsNWidgets(2));
      expect(find.byType(GraficoBarras), findsOneWidget);
      expect(find.text('2 productos se acaban en menos de una semana al ritmo de venta actual'), findsOneWidget);
    });
  ...
  group('estados de carga y error', () {
    testWidgets('mientras llegan los datos hay esqueletos, no gráficos', (tester) async {
      ...
      // 4 indicadores + los 9 marcos.
      expect(find.byType(Esqueleto), findsNWidgets(13));
      expect(find.byType(GraficoLinea), findsNothing);
  ...
  group('período y actualizar', () {
    ...
    testWidgets('cada tablero conserva su propio período', (tester) async {
      ...
      contenedor.read(periodoVentasProvider.notifier).state = PeriodoTablero.atajos()[0];
