...
class MotivoNovedadFormulario extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MotivoNovedadFormulario> createState() =>
      _MotivoNovedadFormularioState();
}

class _MotivoNovedadFormularioState
    extends ConsumerState<MotivoNovedadFormulario> {
  late final _nombre = TextEditingController(text: widget.motivo?.nombre ?? '');
  late final _descripcion = TextEditingController(
    text: widget.motivo?.descripcion ?? '',
  );
  ...
  Future<void> _guardar() async {
    ...
    final cuerpo = <String, dynamic>{
      ...
      'descripcion': _descripcion.text.trim().isNotEmpty
    ...
    try {
      await ref
          .read(motivosNovedadProvider.notifier)
          .guardar(id: widget.motivo?.id, cuerpo: cuerpo);
