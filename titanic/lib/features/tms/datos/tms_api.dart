...
class TmsApi {
  ...
  /// POST /api/mercado
  Future<Mercado> crearMercado(Map<String, dynamic> cuerpo) async =>
      Mercado.desdeJson(
        await _api.post('/mercado', cuerpo: cuerpo) as Map<String, dynamic>,
      );

  /// PUT /api/mercado/{id}
  Future<Mercado> actualizarMercado(
    int id,
    Map<String, dynamic> cuerpo,
  ) async => Mercado.desdeJson(
  ...
  /// POST /api/ruta
  Future<Ruta> crearRuta(Map<String, dynamic> cuerpo) async => Ruta.desdeJson(
    await _api.post('/ruta', cuerpo: cuerpo) as Map<String, dynamic>,
  );

  /// PUT /api/ruta/{id}
  Future<Ruta> actualizarRuta(int id, Map<String, dynamic> cuerpo) async =>
      Ruta.desdeJson(
        await _api.put('/ruta/$id', cuerpo: cuerpo) as Map<String, dynamic>,
      );
}
