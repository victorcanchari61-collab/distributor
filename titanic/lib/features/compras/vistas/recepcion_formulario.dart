...
class _RecepcionFormularioState extends ConsumerState<RecepcionFormulario> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nueva recepción', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
            ...
            InkWell(
              ...
              child: InputDecorator(
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.shopping_bag_outlined, size: 19, color: Colores.tintaTenue),
                ...
                child: Text(
                  _compra == null ? 'Toca para elegir' : '${_compra!.numero} · ${_compra!.proveedor}',
                  style: TextStyle(fontSize: 15, color: _compra == null ? Colores.tintaTenue : Colores.tinta),
                ),
              ),
            )
          else
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colores.tinta),
                  ),
                ],
              ),
            ),
