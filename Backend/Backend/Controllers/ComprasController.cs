...
public class OrdenCompraController : ControllerBase
{
    ...
    [HttpGet]
    [Permiso("compras.ordenes", Accion.Ver)]
    ...
    [HttpPost]
    [Permiso("compras.ordenes", Accion.Crear)]
    ...
    [HttpPut("{id:int}")]
    [Permiso("compras.ordenes", Accion.Editar)]
...
public class CompraController : ControllerBase
{
    ...
    [Permiso("finanzas.pagar", Accion.Ver)]
    ...
    [HttpPost]
    [Permiso("compras.compras", Accion.Crear)]
    ...
    [HttpPut("{id:int}")]
    [Permiso("compras.compras", Accion.Editar)]
    ...
    [HttpPatch("{id:int}/anular")]
    [Permiso("compras.compras", Accion.Anular)]
    public async Task<IActionResult> Anular(int id)
    {
    ...
    [Permiso("compras.compras", Accion.Cobrar)]
